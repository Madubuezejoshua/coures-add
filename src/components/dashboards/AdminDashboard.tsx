...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <DashboardShell title="Admin Dashboard" subtitle="Manage authors, editors, reviewers, publishers and workflow oversight" tabs={TABS} active={activeTab} onChange={setActiveTab}>
